...
if (!empty($_SERVER['PRESSFLOW_SETTINGS'])) {
  ...
  if (!empty($env['conf']['pantheon_binding'])) {
    ...
    define( 'CIVICRM_SITE_KEY', 'b274264b1a5b45d5a55232f4d0b49acc' );
...
define( 'CIVICRM_UF_DSN'           , 'mysql://pantheon:b68c79933f9a42bc92a6a4c7e8a9219c@dbserver.dev.baf61aa0-e678-424b-4b13-65feda566245.drush.in:11806/pantheon?new_link=true' );
...
define( 'CIVICRM_DSN'          , 'mysql://pantheon:b68c79933f9a42bc92a6a4c7e8a9219c@dbserver.dev.baf61aa0-e678-424b-4b13-65feda566245.drush.in:11806/pantheon?new_link=true' );
...
$civicrm_root = '/srv/bindings/86459f25b32a4162976a37f2a55ee27a/code//profiles/civicrm_starterkit/modules/civicrm';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/srv/bindings/86459f25b32a4162976a37f2a55ee27a/code/sites/default/files/civicrm/templates_c/' );
 ...
 *
 */
define( 'CIVICRM_UF_BASEURL'      , 'http://dev-animal-friends-of-lansdowne.gotpantheon.com/profiles/civicrm_starterkit/modules/civicrm/install/index.php/' );
 ...
 */
// define( 'CIVICRM_MAIL_LOG', '/srv/bindings/86459f25b32a4162976a37f2a55ee27a/code/sites/default/files/civicrm/templates_c//mail.log' );
